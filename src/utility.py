...
def LoadDataNoDefCW():
    ...
    ##dataset_dir='C:/Users/user/source/df-master/dataset/ClosedWorld/NoDef/'
    ...
    # Load training data
    handle = open(dataset_dir + 'X_train_NoDef.pkl', 'rb')
    X_train = np.array(pickle.load(handle, encoding='latin1'))
    handle = open(dataset_dir + 'y_train_NoDef.pkl', 'rb')
    ...
    handle = open(dataset_dir + 'X_valid_NoDef.pkl', 'rb')
    X_valid = np.array(pickle.load(handle, encoding='latin1'))
    handle = open(dataset_dir + 'y_valid_NoDef.pkl', 'rb')
    ...
    # Load testing data
    handle = open(dataset_dir + 'X_test_NoDef.pkl', 'rb')
    X_test = np.array(pickle.load(handle, encoding='latin1'))
    handle = open(dataset_dir + 'y_test_NoDef.pkl', 'rb')
